<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteBookRecordPage.aspx.cs" Inherits="LibrarySystem.DeleteBookRecordPage" %>
...
<body>
    ...
    <div style ="margin-left:auto; margin-right:auto; text-align:center">
        ...
        <br />
        <br />
        <asp:Button runat="server" ID="DeleteBook" Text="Delete" Font-Size="X-Large" Font-Bold="true" OnClick="DeleteBookRecordFromDataBase" />
    </div>
    </form>
</body>
</html>
