<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteAuthorRecordPage.aspx.cs" Inherits="LibrarySystem.DeleteAuthorRecordPage" %>
...
<body>
    ...
    <div style ="margin-left:auto; margin-right:auto; text-align:center">
        ...
        <br />
        <br />
        <asp:Button runat="server" ID="DeleteBook" Text="Delete" Font-Size="X-Large" Font-Bold="true" OnClick="DeleteAuthorRecordFromDataBase" />
    </div>
    </form>
</body>
</html>
